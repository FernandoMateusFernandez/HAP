...
-(void) initBackgroundWithBlur:(BOOL)blur
{
    ...
    if (_isShouldBlur)
    {
        ...
        _backgroundBlur.tintColor = [UIColor colorWithRed:0.992 green:0.722 blue:0.004 alpha:1];
    ...
    else
    {
        ...
        _backgroundStatic.backgroundColor = [UIColor colorWithRed:0.992 green:0.722 blue:0.004 alpha:1];
    }
